...
Feature: Editing product's slug in multiple locales
    ...
    Scenario: Creating a product with custom slugs but without a main taxon
        ...
        And I set its slug to "no-taxon-mugs/sir-pugginton" in "English (United States)"
        And I name it "Pluszak Mops Mopsiński" in "Polish (Poland)"
        And I set its slug to "no-taxon-mugs/pan-mopsinski" in "Polish (Poland)"
        And I add it
        Then the slug of the "Pug Pugginton Plushie" product should be "no-taxon-mugs/sir-pugginton" in the "English (United States)" locale
        And the slug of the "Pug Pugginton Plushie" product should be "no-taxon-mugs/pan-mopsinski" in the "Polish (Poland)" locale

    @ui @javascript
    Scenario: Creating a product with autogenerated slugs and a main taxon
        Given I want to create a new simple product
        When I specify its code as "PUG_PUGGINTON_PLUSHIE"
        And I set its price to "$100.00" for "United States" channel
        And I name it "Pug Pugginton Plushie" in "English (United States)"
    ...
    Scenario: Manually modifying slugs on product's names change
        ...
        And I enable slug modification in "Polish (Poland)"
        And I rename it to "Pluszak Mops Mopsak Trzeci" in "Polish (Poland)"
        And I set its slug to "blabla/pan-mopsak-trzeci" in "Polish (Poland)"
        And I save my changes
        Then this product should have slug "blabla/sir-pugston-the-third" in "English (United States)"
        And this product should have slug "blabla/pan-mopsak-trzeci" in "Polish (Poland)"

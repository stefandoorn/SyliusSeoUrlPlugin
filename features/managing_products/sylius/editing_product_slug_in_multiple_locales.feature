...
Feature: Editing product's slug in multiple locales
    ...
    @ui
    Scenario: (Copied From Sylius Core) Creating a product with custom slugs
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Creating a product with autogenerated slugs
        Given I want to create a new simple product
        When I specify its code as "PUG_PUGGINTON_PLUSHIE"
        And I set its price to "$100.00" for "United States" channel
        And I name it "Pug Pugginton Plushie" in "English (United States)"
    ...
    @ui
    Scenario: (Copied From Sylius Core) Seeing disabled slug fields when editing a product
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Slugs don't get updated while changing product's names
        Given the store has a product named "Pug Pugginton Plushie" in "English (United States)" locale and "Pluszak Mops Mopsiński" in "Polish (Poland)" locale
        When I want to modify this product
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Enabling automatic slugs update on product's names change
        Given the store has a product named "Pug Pugginton Plushie" in "English (United States)" locale and "Pluszak Mops Mopsiński" in "Polish (Poland)" locale
        When I want to modify this product
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Manually modifying slugs on product's names change
        Given the store has a product named "Pug Pugginton Plushie" in "English (United States)" locale and "Pluszak Mops Mopsiński" in "Polish (Poland)" locale
        When I want to modify this product
        And I enable slug modification in "English (United States)"
        And I rename it to "Pug Pugston the Third Plushie" in "English (United States)"

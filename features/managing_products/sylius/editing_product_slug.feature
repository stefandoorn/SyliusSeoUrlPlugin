...
Feature: Editing product's slug
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Creating a product with an autogenerated slug
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Creating a product with a custom slug
        Given I want to create a new simple product
        When I specify its code as "BOARD_MANSION_OF_MADNESS"
        And I name it "Mansion of Madness" in "English (United States)"
        And I set its price to "$100.00" for "United States" channel
    ...
    @ui
    Scenario: (Copied From Sylius Core) Seeing disabled slug field when editing a product
        Given the store has a product "Mansion of Madness"
        When I want to modify this product
        Then the slug field should not be editable

    @ui @javascript
    Scenario: (Copied From Sylius Core) Prevent from editing a slug while changing a product name
        Given the store has a product "Mansion of Madness"
        When I want to modify this product
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Automatically changing a product's slug while editing a product's name
        Given the store has a product "Mansion of Madness"
        When I want to modify this product
    ...
    @ui @javascript
    Scenario: (Copied From Sylius Core) Manually changing a product's slug while editing a product's name
        Given the store has a product "Mansion of Madness"
        When I want to modify this product
        And I enable slug modification
        And I rename it to "Small World" in "English (United States)"
